...
"curl ^"https://cgyy.hunnu.edu.cn/api/cdyy/^" ^
  ...
  -H ^"Authorization: JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1******************************************************QbUF6Vzn6k4RPgtNGyRURuTy0Z-Kz7b4YiI9dIFyM^" ^
  ...
  选择场地VENUE_ID = 12（三号场，"venue_id":     【必需】场地ID (9:一, 11:二, 12:三, 13:四, 17:五, 23:六)。）
